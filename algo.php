...
/** Genrating timetable for theory courses, with maximum class for each subject equal to 3 */
for ($I = 0; $I < $subjects_count * 3; $I++) {
    $i = $I % $subjects_count;
    ...
    for ($j = 0; $j < 30; $j++) {
        ...
        if (isset($subjectslots[$sem][$r % 6][$j % 5])) {
            ...
            continue;
        } else if (isset($teachers[$tindex]->days[($sem+1) % 2][$r % 6][$j % 5])) {
            ...
            $teachers[$tindex]->days[($sem+1) % 2][$r % 6][$j % 5] = $subjects[$i]->code;
            $teachers[$tindex]->classroom_names[($sem+1) % 2][$r % 6][$j % 5] = $classroom;
            break;
        }
    }
}
...
for ($I = 0; $I < 2 * $count; $I++) {
    ...
    for ($j = 0; $j < 6; $j++) {
        if (isset($subjectslots[$sem][$j][5])) {
            continue;
        } else if (isset($teachers[$tindex]->days[($sem+1) % 2][$j][5]) || isset($teachers[$tindex2]->days[($sem+1) % 2][$j][5]) ||
            isset($teachers[$tindex3]->days[($sem+1) % 2][$j][5])
        ) {
            continue;
        } else {
            ...
            $teachers[$tindex]->days[($sem+1) % 2][$j][5] = $practicals[$i]->code;
            $teachers[$tindex2]->days[($sem+1) % 2][$j][5] = $practicals[$i]->code;
            $teachers[$tindex3]->days[($sem+1) % 2][$j][5] = $practicals[$i]->code;
            break;
        }
    }
}
